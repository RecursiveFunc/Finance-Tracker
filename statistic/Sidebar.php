<div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 250px; height: 100%;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
            <a href="<?php echo BASE_URL . 'transaction/transaction.php' ?>" class="nav-link link-body-emphasis">
                <svg class="bi pe-none me-2" width="16" height="16">
        ...
        <li>
            <a href="<?php echo BASE_URL . 'statistic/statistic.php' ?>" class="nav-link active" aria-current="page">
                <svg class="bi pe-none me-2" width="16" height="16">
